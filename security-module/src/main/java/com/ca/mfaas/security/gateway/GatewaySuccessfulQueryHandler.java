...
@Component
public class GatewaySuccessfulQueryHandler implements AuthenticationSuccessHandler {
    private final ObjectMapper mapper;
    private final TokenService tokenService;

    public GatewaySuccessfulQueryHandler(ObjectMapper securityObjectMapper,
