...
public class ZosmfFilter extends ZuulFilter {
    ...
    @Autowired
    public ZosmfFilter(MFaaSConfigPropertiesContainer propertiesContainer,
    ...
    public boolean shouldFilter() {
        ...
        return serviceId.equalsIgnoreCase(propertiesContainer.getGateway().getZosmfServiceName());
    }
